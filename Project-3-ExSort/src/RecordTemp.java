...
public class RecordTemp {
     ...
     * @param num_buffers The number of buffers that this RecordTemp is
     *                    allowed to have in memory.
     * @throws IOException An exception that can arise from accessing the disk.
     */
    public RecordTemp(String filename, int num_buffers) throws IOException
    {
        File file = new File(filename);
        pool = new RSBufferPool(file, num_buffers, BLOCK_SIZE);
    }
