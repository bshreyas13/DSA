...
/**
 * A buffer that is backed by a file on the disk. The RSBuffer maintains a
 * pointer back to the RSBufferPool that allocated it so that it can pass
 * updates when it is used.
 * 
 * @author bshreyas and veerad
 * @version 02-26-2021
 */
public class RSBuffer implements Buffer {
    private RSBufferPool pool;
     ...
     * 
     * @param pool
     *            The RSBufferPool that spawned this Buffer.
     * @param file
     *            The file that backs this buffer.
     * @param offset
     *            The offset of this buffer in the file.
     * @param size
     *            The size of this buffer (int bytes).
     */
    public RSBuffer(
        RSBufferPool pool,
